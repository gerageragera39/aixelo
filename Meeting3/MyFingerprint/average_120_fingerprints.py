...
df = pd.read_csv("fingerprints_with_energy.csv", index_col=0)
...
df_grouped.to_csv("fingerprints_grouped_avg_energy.csv")
print("Сохранено в fingerprints_grouped_avg_energy.csv")